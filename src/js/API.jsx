...
let API = {
	...
	getPageByID(url, action, id) {
		var _ = this,
			params = "action=" + action + '&page_id=' + id,
		    ...
		    reqListener = function() {
		    	console.log('AJAX_getPageByID complete: ' + id);
		    };
	...
	AJAX_getPageByID(id){
		if(DataStore.getCachedPage(id)){
			ServerActions.getPageFromCache(id);
		} else {
			var _ = this;
			_.getPageByID(window.AjaxSubmit.ajaxSubmitURL, 'get_page_by_id', id);
		}
	}
};
