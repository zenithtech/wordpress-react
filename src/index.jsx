...
if(document.getElementById('react_header')){
    class ReactHeader extends Component {
        ...
        render() {
            ...
            if( ds.getWpVars('blogdescription') ) {
                blogdescription = ds.getWpVars('blogdescription');
            }
            return (
                <header className="clearfix">
                    <div className="container">
                        <p>{blogdescription}</p>
                        <Menu menu_name="Top Menu" id="top-menu" {..._.props} {..._.state} />
                    </div>
                </header>
            );
        }
...
API.set_menu_tree(DataStore.getWpVars('menus'));
